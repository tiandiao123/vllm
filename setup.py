...
setup(
    name='vllm-cuda-kernels',
    ext_modules=[
        CUDAExtension(
            name="vllm.pos_encoding_ops",
            sources=["csrc/rotary_embedding/pos_encoding.cpp", "csrc/rotary_embedding/pos_encoding_kernels.cu"],
            extra_compile_args={
                               'cxx': ['-O3',],
        ...
        CUDAExtension(
            ...
            sources=["csrc/layernorm/layernorm.cpp", "csrc/layernorm/layernorm_kernels.cu"],
            extra_compile_args={
                               'cxx': ['-O3',],
                               'nvcc': append_nvcc_threads(['-O3', '--use_fast_math'] + cc_flag)
                                },
